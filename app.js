...
const questions = [
  ...
  { text: "Что должен делать сотрудник ВП при проверке ВЧ на ЧС, помимо самой проверки?", correct: "Проверять состав мо" },
  ...
  { text: "Каким цветом должен быть автомобиль сотрудника ВП?", correct: "Чёрный серый" },
  { text: "Что можно носить сотруднику ВП?(аксессуары)", correct: "Часы усы" },
  { text: "Какая приписка в рации департамента?", correct: "ВП" },
  { text: "Сколько минимум минут проверять ВЧ на чс?", correct: "3 минуты" },
  { text: "Кому подчиняются сотрудники ВП?", correct: "Куратор ВП, Ст.Офицер" },
  ...
  { text: "Недельная норма проверок от состава ВП?", correct: "3 раза в неделю минимум" }
];
