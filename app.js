...
const FIXED_EMPLOYEE_STRUCTURE = [
    ...
    { id: 'officer_3', position: 'Офицер ВП', type: 'officer', username: 'Ara_Armatura' },
...
const retrainingQuestions = [
    ...
    // { text: "Представим ситуацию, вы помогаете своему руководству с собеседованиями, в рации вы услышали что на вашей ВЧ ЧС, после его устранения вы видите что из-за двери военкомата виднеется бандит. Ваши действия?" },
